...
public class UserCfMapReduceJob {
    ...
    public static void main(String[] args) throws InterruptedException, IOException, ClassNotFoundException {
        String inputPath = "/user/root/mr/data/cf/data/sim_result/part-r-00000";
        String outputPath = "/user/root/mr/data/cf/data/cf_result";
        String itemPath = "/user/root/mr/data/cf/data/result/item";
        String userItemScorePath = "/user/root/mr/data/cf/data/score_matrix/part-r-00000";
        int topN = 200;
